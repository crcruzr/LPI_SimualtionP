...
f1c <- read.csv('04FinalData/complete/simulated/Conv_conc_lin/Conv_conc_lin.csv')
f1c <- plot_lpi_table(f1c, colors = colors);f1c
...
lpi_resultNA <- read.csv('04FinalData/constrain/napermutation_unique/napermutation_unique.csv')
f2b <- plot_lpi(lpi_resultNA, colr = colr, show_label = FALSE, label_name = "");f2b
...
f2
ggsave(filename = "05Plots/Fig2.jpeg", plot = f2, width = 10, height = 6.5, units = "in", dpi = 300)
